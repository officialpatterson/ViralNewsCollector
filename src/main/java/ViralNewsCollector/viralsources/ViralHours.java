 ...
 */
public class ViralHours extends ViralSource {
    private String rootURL = "http://viralhours.com";
    ...
    public void crawl() {
        ...
        try {
            ...
            Elements links = doc.select("#contentwrap a");
