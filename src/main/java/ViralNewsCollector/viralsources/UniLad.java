 ...
 * Retrieves viral content from unilad by retrieving articles tagged viral
 */
public class UniLad extends ViralSource {
    private String rootURL = "http://www.unilad.co.uk/viral/";
    ...
    public void crawl() {
        ...
        try {
            ...
            Elements links = doc.select("h2.prl-article-title a");
